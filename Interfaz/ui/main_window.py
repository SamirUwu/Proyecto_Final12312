...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        # ── Pause/Play button (sobre plot_pre) ────────────────────────────────
        self.paused = False
        ...
        # ── Botón modo claro (sobre plot_pre, esquina superior derecha) ───────
        self.theme_label = QLabel("☀ Modo Claro", self.plot_pre)
        ...
        self.theme_label.adjustSize()
        self.theme_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.theme_label.move(self.plot_pre.width() - self.theme_label.width() - 10, 10)
    ...
    def _apply_theme(self):
        ...
        # Actualizar fill si FFT está activo
        if self.show_fft:
        ...
        if self.light_mode:
            ...
            self.theme_label.setText("☀ Modo Claro")
            self.theme_label.setStyleSheet("""
                QLabel {
                    color: #aaaaaa;
                    background-color: rgba(0,0,0,180);
    ...
    def resizeEvent(self, event):
        ...
        self.theme_label.move(
            self.plot_pre.viewport().width() - self.theme_label.width() - 10, 40
        )